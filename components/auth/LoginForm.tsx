...
// configured on the Convex deployment. Without this, clicking the buttons
// throws an opaque server-side error (the providers are still registered in
// convex/auth.ts so flipping the flag works without a code change).
...
const HAS_RESEND = process.env.NEXT_PUBLIC_AUTH_RESEND_ENABLED === "1";
