          ...
          >
            ...
            {canManage ? (
              <button
                ...
                className="absolute right-[8px] top-[8px] rounded bg-pign-black/70 p-[4px] text-white opacity-0 transition-opacity group-hover:opacity-100"
              >
