...
/** Shared list grid — NAME, VERIFIED, SIZE, LAST UPLOADED, actions. */
export const SHARED_GRID_COLS =
  "grid grid-cols-[1fr_96px_96px_130px_40px] items-center pl-[30px] pr-[35px]";

type SharedFileRowProps = {
  doc: FileDoc;
  selected?: boolean;
  onSelect?: (id: Id<"documents">) => void;
  /** When false, hides verify action and context menu (files shared with the user). */
  canManage?: boolean;
};

export function SharedFileRow({
  doc,
  selected,
  onSelect,
  canManage = true,
