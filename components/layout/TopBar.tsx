  ...
  return (
    <header className="h-16 border-b border-grey-6 bg-white flex items-center justify-between px-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="w-9 h-9 rounded-full bg-pign-black text-white flex items-center justify-center">
          <HelpCircle size={16} />
        </button>

        <button className="relative w-9 h-9 rounded-full bg-grey-7 flex items-center justify-center">
